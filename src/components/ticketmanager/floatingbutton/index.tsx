...
const Floating = () => {
    ...
    return (
        <View style={s.container}>
            <Animated.View
                style={[s.contentContainer, firstIcon, firstWidthStyle]}
            >

                <View style={s.iconContainer}>
                    <TouchableOpacity onPress={() => console.log("My Tickets")}>
                        <Image
                            source={require('@/assets/ticket-icon-white.png')}
                            style={{
                                width: 32,
                                height: 28,
                            }}
                ...
                <TouchableOpacity onPress={() => console.log("My Tickets")}>
                    <Animated.Text style={[s.text, opacityText]}>
            ...
            <Pressable
                ...
                <Animated.View style={[s.iconContainer, plusIcon]}>
                    <Image
